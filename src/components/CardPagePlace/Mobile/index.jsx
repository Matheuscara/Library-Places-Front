...
function CardPagePlaceMobile() {
  return (
    <div>
      <img
        className="imgCardPagePlaceMobile"
      ...
      <p className="descriptionCardPagePlaceMobile">
        ...
        etiam id senectus arcu. Lacus, lorem lorem tristique facilisi tincidunt
      </p>
...
export default CardPagePlaceMobile
